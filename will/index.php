...
<head>
  ...
  <title>Will Platform - Administrator Homepage</title>
...
<td><button onclick="return confirm('Are you sure you want to delete this user?')?window.location.href='insertion.inc.php?action=deleteU&id=<?php echo($row["User_ID"]); ?>':true;" title='Remove User'>Delete</button></td>
</tr>
<?php
}
...
<td><button onclick="return confirm('Are you sure you want to delete this will?')?window.location.href='insertion.inc.php?action=deleteW&id=<?php echo($row["Will_ID"]); ?>':true;" title='Remove Will'>Delete</button></td>
</tr>
<?php
}
} else { echo "No results"; }
...
?>
    ...
    <section class="contact_section" id="start">
      <div class="container">
        <div class="heading_container">
          <h2>
            Update My Details & Register A User
          </h2>
        </div>
      </div>
